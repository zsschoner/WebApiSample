...
namespace ApiMvc
{
    public static class WebApiConfig
    {
        ...
        {
            // Default API route
            config.Routes.MapHttpRoute(name: "DefaultApi", routeTemplate: "api/{controller}/{uid}",
                                       defaults: new {uid = RouteParameter.Optional});

            // Rest parameterized URL
            config.Routes.MapHttpRoute(name: "RestUserUpdate",
            ...
            if (cfg != null)
            {
                cfg.SupportedMediaTypes.Add(new MediaTypeHeaderValue("text/html"));
            }
        }
